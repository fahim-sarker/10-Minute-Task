  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      <div className="flex items-start space-x-4">
        <img
          src={instructor.image || "/placeholder.svg?height=80&width=80&query=instructor"}
          alt={instructor.name}
        ...
        <div className="flex-1">
          ...
          {instructor.bio && <p className="text-gray-600 text-sm leading-relaxed">{instructor.bio}</p>}
        </div>
      </div>
    </div>
  )
