    ...
    <div className="bg-black rounded-lg p-8 text-white">
      <div className="text-center">
        ...
        <button
          ...
          className="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-colors duration-300 inline-flex items-center space-x-2 mb-4"
        >
